# LANG: RUSSIAN [RUSSIA] LANG CODE: RUS                          >>  copyright ©️ 2021 ajak4405  <<                                         fileName : lang/hnd.py
...
SETTINGS = {
    "default": ["ПО УМОЛЧАНИЮ ❌", "НАСТРОЙКА ✅"], "chgLang": {"НАСТРОЙКА ⚙️» ИЗМЕНИТЬ ЯЗЫК 🌐": "ajak4405"},
    ...
    "wait" : {"Жду.. 🥱" : "ajak4405"}, "back" : {"« НАЗАД ДОМОЙ «" : "Home|B2S"}, "errorCB" : {"« НАЗАД ДОМОЙ »": "Home|B2A"},
    ...
    "большой палец" : [
        {"» НАСТРОЙКА ⚙️ » МИНИАТЮР 📷 »" : "ajak4405", "« ♻ ДОБАВИТЬ ♻ »" : "set|thumb+", "« НАЗАД НА ДОМОЙ «" : "Домой|B"},
        {"» НАСТРОЙКА ⚙️ » МИНИАТЮР 📷 »" : "ajak4405", "« ♻ ИЗМЕНИТЬ ♻ »" : "set|thumb+", "« 🗑 УДАЛИТЬ 🗑 »" : "set|thumb-", "« НАЗАД НА ДОМОЙ »" : "Home|B2S"}
    ],
    "фамия": [
        {"» SETTING ⚙️ » FNAME 📷 »" : "ajak4405", "« ♻ ДОБАВИТЬ ♻ »" : "set|fname+", "« НАЗАД НА ДОМОЙ «" : "Home|B2S"},
        {"» НАСТРОЙКА ⚙️ » FNAME 📷 »" : "ajak4405", "« ♻ ИЗМЕНИТЬ ♻ »" : "set|fname+", "« 🗑 УДАЛИТЬ 🗑 »" : "set|fname-", "« НАЗАД НА ДОМОЙ »" : "Home|B2S"}
    ],
    "апи": [
        {"» НАСТРОЙКА ⚙️ » API 📷 »" : "ajak4405", "« ♻ ДОБАВИТЬ ♻ »" : "set|api+", "« НАЗАД НА ДОМОЙ «" : "Home|B2S"},
        {"» НАСТРОЙКА ⚙️ » API 📷 »" : "ajak4405", "« ♻ ИЗМЕНИТЬ ♻ »" : "set|api+", "« 🗑 УДАЛИТЬ 🗑 »" : "set|api-", "« НАЗАД НА ДОМ »" : "Home|B2S"}
    ],
    "капитан": [
        {"» НАСТРОЙКА ⚙️ » ЗАГОЛОВОК 📷 »" : "ajak4405", "« ♻ ДОБАВИТЬ ♻ »" : "set|capt+", "« НАЗАД НА ДОМОЙ «" : "Home|B2S"},
        {"» НАСТРОЙКА ⚙️ » ЗАГОЛОВОК 📷 »" : "ajak4405", "« ♻ ИЗМЕНИТЬ ♻ »" : "set|capt+", "« 🗑 УДАЛИТЬ 🗑 »" : "set|capt-", "« НАЗАД НА ДОМОЙ »" : "Home|B2S"}
    ]
}
...
STATUS_MSG = {
    ...
    "_HOME" : {
        "« 📊 ↓ СЕРВЕР ↓ 📊 »" : "ajak4405", "« 📶 ХРАНИЛИЩЕ 📶 »": "status|server",
        "« 🥥 БАЗА ДАННЫХ 🥥 »": "status|db", "« 🌝 ↓ ПОЛУЧИТЬ СПИСОК ↓ 🌝 »": "ajak4405",
...
Вещи с PDF-файлами @Telegram\n\nСпасибо @ajak4405 за этого замечательного бота 😅""",
    "HomeACB": {
...
PROGRESS = {
    ...
    "dlFile": "`Скачивание вашего файла..` 📥", "upFileCB" : {"📤 .. ЗАГРУЗКА.. 📤" : "ajak4405"},
...
GENERATE = {
    ...
    "geting" : "Имя файла: `{}`\nСтраницы: `{}`", "getingCB" : {"📚 GENERATING PDF.." : "ajak4405"},
...
\n`Пожалуйста, пришлите мне файл меньше {}mb Size` 🙃""",
    "bigCB" : {"💎 Создать бота поддержки 2Gb 💎" : "https://github.com/ajak4405/ilovepdf"},
...
split = {
    ...
    "кнопка" : {
        "« ⚙️ PDF » РАЗДЕЛИТЬ ↓ »" : "ajak4405", "« 🦞 With In Range 🦞 »" : "split|R",
...
pdf2IMG = {
    ...
    "toImage" : {
        "» ⚙ PDF » ИЗОБРАЖЕНИЯ ↓ »" : "ajak4405", "« 🖼 IMG 🖼 »" : "pdf|img|img",
        "« 📂 DOC 📂": "pdf|img|doc", "« 🤐 ZIP 🤐 »" : "pdf|img|zip",
        "« 🎯 TAR 🎯 »" : "pdf|img|tar", "« НАЗАД »" : "pdf"
    },
    "диапазон изображений": {
        "» ⚙️ PDF » ИЗОБРАЖЕНИЯ » {} ↓" : "ajak4405", "🙄 ВСЕ 🙄" : "p2img|{}A",
...
work = {
    ...
    "txt" : {
        "» ⚙️ PDF » TXT ↓ »" : "ajak4405", "« 📜 СООБЩЕНИЕ 📜 »" : "work|M", "« 🧾 TXT FIL 🧾 »" : "work|T",
...
pdf2TXT = {
    ...
    "font_btn": {
        "TXT@PDF » SET FONT »" : "ajak4405", "« Times »" : "pdf|font|t", "« Courier »" : "pdf|font|c", "« Helvetica (по умолчанию) »" : "pdf|font|h",
        "« Symbol »": "pdf|font|s", "« Zapfdingbats »": "pdf|font|z", "« 🚫 CLOSE 🚫 »": "close|me"
    },
    "size_btn" : { "TXT@PDF » {} » SET SCALE »" : "ajak4405", "« Portarate »" : "t2p|{}|p", "« Landscape »" : "t2p|{}|l", "« Назад «": "pdf|T2P"},
